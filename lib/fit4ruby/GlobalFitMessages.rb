...
module Fit4Ruby
  ...
  GlobalFitMessages = GlobalFitMessageList.new do
    ...
    field 45, 'uint16', 'threshold_power', :unit => 'watts'
    ...
    field 49, 'uint16', 'avg_altiturde', :scale => 5, :offset => 500, :unit => 'm'
    field 50, 'uint16', 'max_altitude', :scale => 5, :offset => 500, :unit => 'm'
    field 51, 'uint8', 'gps_accuracy', :unit => 'm'
    field 52, 'sint16', 'avg_grade', :scale => 100, :unit => 'percent'
    field 53, 'sint16', 'avg_pos_grade', :scale => 100, :unit => 'percent'
    field 54, 'sint16', 'avg_neg_grade', :scale => 100, :unit => 'percent'
    field 55, 'sint16', 'max_pos_grade', :scale => 100, :unit => 'percent'
    field 56, 'sint16', 'max_neg_grade', :scale => 100, :unit => 'percent'
    field 57, 'sint8', 'avg_temperature', :unit => 'C'
    field 58, 'sint8', 'max_temperature', :unit => 'C'
    field 59, 'unit32', 'total_moving_time', :scale => 1000, :unit => 's'
    field 60, 'sint16', 'avg_pos_vertical_speed', :scale => 1000, :unit => 'm/s'
    field 61, 'sint16', 'avg_neg_vertical_speed', :scale => 1000, :unit => 'm/s'
    field 62, 'sint16', 'max_pos_vertical_speed', :scale => 1000, :unit => 'm/s'
    field 63, 'sint16', 'max_neg_vertical_speed', :scale => 1000, :unit => 'm/s'
    field 64, 'uint8', 'min_heart_rate', :unit => 'bpm'
    field 65, 'uint32', 'time_in_hr_zone', :array => true, :scale => 1000, :unit => 's'
    field 66, 'uint32', 'time_in_speed_zone', :array => true, :scale => 1000, :unit => 's'
    field 67, 'uint32', 'time_in_cadence_zone', :array => true, :scale => 1000, :unit => 's'
    field 68, 'uint32', 'time_in_power_zone', :array => true, :scale => 1000, :unit => 's'
    field 69, 'uint32', 'avg_lap_time', :scale => 1000, :unit => 's'
    field 70, 'uint16', 'best_lap_index'
    field 71, 'uint16', 'min_altitude', :scale => 5, :offset => 500, :unit => 'm'
    field 78, 'uint32', 'undocumented_field_78'
    field 79, 'uint16', 'undocumented_field_79'
    field 80, 'uint16', 'undocumented_field_80'
    field 81, 'enum', 'undocumented_field_81'
    field 82, 'uint16', 'player_score'
    field 83, 'uint16', 'opponent_score'
    field 84, 'string', 'opponent_name'
    field 85, 'uint16', 'stroke_count', :array => true, :unit => 'count'
    field 86, 'uint16', 'zone_count', :array => true, :unit => 'count'
    field 87, 'uint16', 'max_ball_speed', :array => true, :scale => 100, :unit => 'm/s'
    field 88, 'uint16', 'avg_ball_speed', :array => true, :scale => 100, :unit => 'm/s'
    ...
    field 98, 'uint16', 'avg_saturated_hemoglobin_percent', :array => true, :scale => 10, :unit => 'percent'
    field 99, 'uint16', 'min_saturated_hemoglobin_percent', :array => true, :scale => 10, :unit => 'percent'
    field 100, 'uint16', 'max_saturated_hemoglobin_percent', :array => true, :scale => 10, :unit => 'percent'    
    ...
    field 129, 'uint16', 'avg_lev_motor_power', :unit => 'watts'
    field 130, 'uint16', 'max_lev_motor_power', :unit => 'watts'
    field 131, 'uint8', 'lev_battery_consumption', :scale => 2, :unit => 'percent'    
    ...
    field 27, 'sint32', 'nec_lat', :type => 'coordinate' #guessed
    field 28, 'sint32', 'nec_long', :type => 'coordinate' #guessed
    field 29, 'sint32', 'swc_lat', :type => 'coordinate' #guessed
    field 30, 'sint32', 'swc_long', :type => 'coordinate' #guessed
    ...
    field 42, 'uint16', 'avg_altitude', :scale => 5, :offset => 500, :unit => 'm'
    field 43, 'uint16', 'max_altitude', :scale => 5, :offset => 500, :unit => 'm'
    field 44, 'uint8', 'gps_accuracy', :unit => 'm'
    field 45, 'sint16', 'avg_grade', :scale => 100, :unit => 'percent'
    field 46, 'sint16', 'avg_pos_grade', :scale => 100, :unit => 'percent'
    field 47, 'sint16', 'avg_neg_grade', :scale => 100, :unit => 'percent'
    field 48, 'sint16', 'max_pos_grade', :scale => 100, :unit => 'percent'
    field 49, 'sint16', 'max_neg_grade', :scale => 100, :unit => 'percent'
    field 50, 'sint8', 'avg_temperature', :unit => 'C'
    field 51, 'sint8', 'max_temperature', :unit => 'C'
    field 52, 'uint32', 'total_moving_time', :scale => 1000, :unit => 's'
    field 53, 'sint16', 'avg_pos_vertical_speed', :scale => 1000, :unit => 'm/s'
    field 54, 'sint16', 'avg_neg_vertical_speed', :scale => 1000, :unit => 'm/s'
    field 55, 'sint16', 'max_pos_vertical_speed', :scale => 1000, :unit => 'm/s'
    field 56, 'sint16', 'max_neg_vertical_speed', :scale => 1000, :unit => 'm/s'
    field 57, 'uint32', 'time_in_hr_zone', :array => true, :scale => 1000, :unit => 's'
    field 58, 'uint32', 'time_in_speed_zone', :array => true, :scale => 1000, :unit => 's'
    field 59, 'uint32', 'time_in_cadence_zone', :array => true, :scale => 1000, :unit => 's'
    field 60, 'uint32', 'time_in_power_zone', :scale => 1000, :unit => 's'
    field 61, 'uint16', 'repetition_num'
    field 62, 'uint16', 'min_altitude', :scale => 5, :offset => 500, :unit => 'm'
    field 63, 'uint8', 'min_heart_rate', :unit => 'bpm'    
    ...
    field 74, 'uint16', 'opponent_score'
    field 75, 'uint16', 'stroke_count', :array => true, :unit => 'count'
    field 76, 'uint16', 'zone_count', :array => true, :unit => 'count'
    ...
    field 83, 'uint16', 'player_score'
    field 84, 'uint16', 'avg_total_hemoglobin_conc', :array => true, :scale => 100, :unit => 'g/dL'
    field 85, 'uint16', 'min_total_hemoglobin_conc', :array => true, :scale => 100, :unit => 'g/dL'
    field 86, 'uint16', 'max_total_hemoglobin_conc', :array => true, :scale => 100, :unit => 'g/dL'
    field 87, 'uint16', 'avg_saturated_hemoglobin_percent', :array => true, :scale => 10, :unit => 'percent'
    field 88, 'uint16', 'min_saturated_hemoglobin_percent', :array => true, :scale => 10, :unit => 'percent'
    field 89, 'uint16', 'max_saturated_hemoglobin_percent', :array => true, :scale => 10, :unit => 'percent'
    ...
    field 115, 'uint16', 'avg_lev_motor_power', :unit => 'watts'
    field 116, 'uint16', 'max_lev_motor_power', :unit => 'watts'    
    field 117, 'uint8', 'lev_battery_consumption', :scale => 2, :unit => 'percent' 
    ...
    field 17, 'uint8', 'speed_1s', :array => true, :scale => 16, :unit => 'm/s'
    field 18, 'uint8', 'cycles', :unit => 'cycles'
    field 19, 'uint32', 'total_cycles', :unit => 'cycles'
    field 28, 'uint16', 'compressed_accumulated_power', :unit => 'watts'
    field 29, 'uint32', 'accumulated_power', :unit => 'watts'
    field 30, 'uint8', 'left_right_balance', :dict => 'left_right_balance'
    field 31, 'uint8', 'gps_accuracy', :unit => 'm'
    field 32, 'sint16', 'vertical_speed', :scale => 1000, :unit => 'm/s'
    field 33, 'uint16', 'calories', :unit => 'kcal'
    ...
    field 48, 'uint8', 'time128', :scale => 128, :unit => 's'
    field 50, 'uint8', 'zone'
    field 51, 'uint16', 'ball_speed', :scale => 100, :unit => 'm/s'
    field 52, 'uint16', 'cadence256', :scale => 256, :unit => 'rpm'
    field 53, 'uint8', 'fractional_cadence', :scale => 128
    field 54, 'uint16', 'total_hemoglobin_conc', :scale => 100, :unit => 'g/dL'
    field 55, 'uint16', 'total_hemoglobin_conc_min', :scale => 100, :unit => 'g/dL'
    field 56, 'uint16', 'total_hemoglobin_conc_max', :scale => 100, :unit => 'g/dL'    
    field 57, 'uint16', 'saturated_hemoglobin_percent', :scale => 10, :unit => '%'
    field 58, 'uint16', 'saturated_hemoglobin_percent_min', :scale => 10, :unit => '%'
    field 59, 'uint16', 'saturated_hemoglobin_percent_max', :scale => 10, :unit => '%'
    ...
    field 78, 'uint32', 'enhanced_altitude', :scale => 5, :offset => 500, :unit => 'm'
    field 81, 'uint8', 'battery_soc', :scale => 2, :unit => 'percent'
    field 82, 'uint16', 'motor_power', :unit => 'watts'
    field 83, 'uint16', 'vertical_ratio', :scale => 100, :unit => 'percent' 
    field 84, 'uint16', 'stance_time_balance', :scale => 100, :unit => 'percent'
    field 85, 'uint16', 'step_length', :scale => 10, :unit => 'mm'
    ...
    field 91, 'uint32', 'absolute_pressure', :unit => 'Pa'
    field 92, 'uint32', 'depth', :scale => 1000, :unit => 'm'
    field 93, 'uint32', 'next_stop_depth', :scale => 1000, :unit => 'm'
    field 94, 'uint32', 'next_stop_time', :scale => 1, :unit => 's'    
    field 95, 'uint32', 'time_to_surface', :scale => 1, :unit => 's'
    field 96, 'uint32', 'ndl_time', :scale => 1, :unit => 's'
    field 97, 'uint8', 'cns_load', :unit => 'percent'
    field 98, 'uint16', 'n2_load', :scale => 1, :unit => 'percent'
    field 253, 'uint32', 'timestamp', :type => 'date_time'
